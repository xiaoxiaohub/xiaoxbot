...
#ifndef XIAOX_INTERFACES__SRV__DETAIL__READ_JOINTS__FUNCTIONS_H_
#define XIAOX_INTERFACES__SRV__DETAIL__READ_JOINTS__FUNCTIONS_H_
...
/// Initialize srv/ReadJoints message.
/**
...
/// Finalize srv/ReadJoints message.
/**
...
/// Create srv/ReadJoints message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xiaox_interfaces__srv__ReadJoints_Request__init().
...
/// Destroy srv/ReadJoints message.
/**
 * It calls
 * xiaox_interfaces__srv__ReadJoints_Request__fini()
...
/// Check for srv/ReadJoints message equality.
/**
...
/// Initialize array of srv/ReadJoints messages.
/**
...
/// Finalize array of srv/ReadJoints messages.
/**
 * It calls
 * xiaox_interfaces__srv__ReadJoints_Request__fini()
...
/// Create array of srv/ReadJoints messages.
/**
 * It allocates the memory for the array and calls
 * xiaox_interfaces__srv__ReadJoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ReadJoints messages.
/**
 * It calls
 * xiaox_interfaces__srv__ReadJoints_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ReadJoints message array equality.
/**
...
/// Copy an array of srv/ReadJoints messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xiaox_interfaces__srv__ReadJoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xiaox_interfaces
...
/**
 * It calls
 * xiaox_interfaces__srv__ReadJoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_xiaox_interfaces
...
/**
 * It allocates the memory for the array and calls
 * xiaox_interfaces__srv__ReadJoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xiaox_interfaces
...
/**
 * It calls
 * xiaox_interfaces__srv__ReadJoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // XIAOX_INTERFACES__SRV__DETAIL__READ_JOINTS__FUNCTIONS_H_
