...
static const _WriteJoints_Request_type_support_symbol_names_t _WriteJoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xiaox_interfaces, srv, WriteJoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xiaox_interfaces, srv, WriteJoints_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xiaox_interfaces, srv, WriteJoints_Request)() {
  return &::xiaox_interfaces::srv::rosidl_typesupport_c::WriteJoints_Request_message_type_support_handle;
}
...
static const _WriteJoints_Response_type_support_symbol_names_t _WriteJoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xiaox_interfaces, srv, WriteJoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xiaox_interfaces, srv, WriteJoints_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xiaox_interfaces, srv, WriteJoints_Response)() {
  return &::xiaox_interfaces::srv::rosidl_typesupport_c::WriteJoints_Response_message_type_support_handle;
}
...
static const _WriteJoints_type_support_symbol_names_t _WriteJoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xiaox_interfaces, srv, WriteJoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xiaox_interfaces, srv, WriteJoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, xiaox_interfaces, srv, WriteJoints)() {
  return &::xiaox_interfaces::srv::rosidl_typesupport_c::WriteJoints_service_type_support_handle;
}
